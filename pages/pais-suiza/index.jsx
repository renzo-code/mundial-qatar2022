  ...
  return(
    <Layout>
      <ViewCountry
        ...
        description="Tras una infartante definición en la fase de grupos de las eliminatorias europeas, 
                    Suiza logró ganar su zona, mandó a Italia al repechaje y consiguió el cupo directo 
                    a Qatar 2022. Pese a no contar con grandes figuras, el técnico Murat Yakin formó un 
                    colectivo muy sólido y cuenta con la experiencia de Xherdan Shaqiri. "
        nameDT="MURAT YAKIN"
