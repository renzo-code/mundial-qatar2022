  ...
  return(
    <Layout>
      <ViewCountry
        ...
        description="Pese a que se les conoce como los inventores del fútbol, los Three Lions solo pudieron 
                    coronarse como campeones del mundo una sola vez, en 1966. Desde entonces, no han podido 
                    repetido la hazaña. En Rusia 2018, se quedaron por poco, pues cayeron eliminados ante 
                    Croacia en semifinales. De la mano de Gareth Southgate, Harry Kane y Jack Grealish esperan 
