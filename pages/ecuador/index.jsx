  ...
  return(
    <Layout>
      <ViewCountry
        ...
        description="El ‘Tri’ llega con la firme convicción de dejar huella. Tras dos mundiales ausente y 
                    pese a que su historial en este certamen es corto, la escuadra sudamericana quiere superar 
                    lo hecho en el 2006, torneo en el que alcanzó los octavos de final."
        ...
        dataInfo2="Cuatro participaciones en la Copa del Mundo, incluyendo Qatar 2022"
      />
    </Layout>
  )
}
